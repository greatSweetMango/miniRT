...
// get_scene_texutre.c
void			set_plane_texture(t_scene *scene,
					t_texture *texture, char **object);
void			set_cylinder_texture(t_scene *scene,
					t_texture *texture, char **object);
void			set_sphere_texture(t_scene *scene,
					t_texture *texture, char **object);
...
void			get_cylinder_body_normal(
					t_hit_info *hit_info, t_cylinder *cylinder);
//check_cylinder_body2.c
t_rgb			get_cylinder_body_color(
					t_cylinder *cylinder, t_hit_info *hit_info);
...
t_rgb			get_cylinder_head_color(
					t_cylinder *cylinder, t_hit_info *hit_info);
double			get_cylinder_head_t(
					t_cylinder *cylinder, t_ray ray, t_vec3 orient);
...
// check_disk.c
void			get_cone_bottom(
					t_hit_info *hit_info, t_ray ray, t_list *cone_list);
// check_light.c
t_hit_info		add_light(
					t_hit_info hit_info, t_list *lst_light, t_scene *scene);
double			get_light_ratio(
					t_hit_info hit_info, t_light *light, t_scene *scene);
...
t_rgb			get_sphere_checker_color(
					double phi, double theta, t_sphere *sphere);
// check_plane.c
...
void			set_sphere_hit_info(
					t_hit_info *hit_info, t_list *sp, t_ray ray);
// check_sphere2.c
...
// rt_utils.c
t_rgb			add_ambient_light(
					t_rgb color, t_ambient_lightning ambient_light);
...
// texture_cylinder.c
t_rgb	 		texture_cylinder_body(
					t_cylinder *cylinder, t_hit_info *hit_info);
void			get_cylinder_theta_height(
					double *theta, double *height,
					t_cylinder *cylinder, t_hit_info *hit_info);
